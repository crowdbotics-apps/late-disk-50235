"""
Django settings for late_disk_50235 project.
...
ROOT_URLCONF = 'late_disk_50235.urls'
...
WSGI_APPLICATION = 'late_disk_50235.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Late Disk Support <support@late-disk-50235.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "late_disk_50235 API",
    "DESCRIPTION": "API documentation for late_disk_50235 App",
    "VERSION": "v1",
}
...
if AS_BUCKET_NAME:
    ...
    DEFAULT_FILE_STORAGE = "late_disk_50235.storage_backends.AzureMediaStorage"
    STATICFILES_STORAGE = "late_disk_50235.storage_backends.AzureStaticStorage"
